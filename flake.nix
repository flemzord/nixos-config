{
  ...
  outputs = { self, darwin, nix-homebrew, homebrew-core, homebrew-cask, formancehq-cask, loftsh-cask, earthly-cask, koyeb-cask, speakeasy-cask, home-manager, nixpkgs, disko, agenix, vscode-server, vector-cask } @inputs: {
    nixosConfigurations = {
