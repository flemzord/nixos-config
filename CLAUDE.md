...
This project is indexed by GitNexus as **nixos-config** (355 symbols, 513 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
