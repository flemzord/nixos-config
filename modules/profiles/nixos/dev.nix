...
let
  cfg = config.profiles.nixos.dev;
in
{
  options.profiles.nixos.dev.manageAiCliConfig = lib.mkOption {
    type = lib.types.bool;
    default = true;
    description = "Manage Claude Code and Codex user configuration with Home Manager.";
  };
  ...
  config = {
    ...
    environment.systemPackages =
      (pkgs.callPackage ../common/dev-packages.nix { })
      ++ (with pkgs; [
